...
The executable accepts the vector size `T` as the first positional argument, as required by the revised specification. If additional execution parameters are needed, they must appear after `T`:
